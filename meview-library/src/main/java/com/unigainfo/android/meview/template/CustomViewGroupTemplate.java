package com.unigainfo.android.meview.template;
 ...
 */
class CustomViewGroupTemplate extends BaseCustomViewGroup {
    ...
    private void initInflate() {
        inflate(getContext(), R.layout.meview_sample_layout, this);
    }
