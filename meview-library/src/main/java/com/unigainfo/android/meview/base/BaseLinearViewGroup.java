...
public abstract class BaseLinearViewGroup extends LinearLayout {
    public BaseLinearViewGroup(Context context) {
        super(context);
    }

    public BaseLinearViewGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BaseLinearViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public BaseLinearViewGroup(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
