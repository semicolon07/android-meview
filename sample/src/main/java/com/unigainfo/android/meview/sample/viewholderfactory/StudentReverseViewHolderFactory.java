...
public class StudentReverseViewHolderFactory extends ViewHolderFactory<Student,StudentReverseViewHolderFactory.ViewHolder> {
    private final Listener listener;

    public interface Listener{
        void onStudentItemClick(Student item);
    }
    public StudentReverseViewHolderFactory(Listener listener){
    ...
    public int getLayoutRes() {
        return R.layout.list_item_student_reverse;
    }
